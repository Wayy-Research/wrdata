...
def test_connection():
    """Test if we can connect to OKX API."""
    provider = OKXProvider()  # No API key needed!
...
if __name__ == "__main__":
    ...
    print("- Spot, futures, perpetual data")
